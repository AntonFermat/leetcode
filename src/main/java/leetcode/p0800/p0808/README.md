<h2><a href="https://leetcode.com/problems/soup-servings/">802. Find Eventual Safe States</a></h2>
<h3>Medium</h3>
<div class="flex"></div><div class="_1l1MA" data-track-load="description_content"><p>There are two types of soup: <strong>type A</strong> and <strong>type B</strong>. Initially, we have <code>n</code> ml of each type of soup. There are four kinds of operations:</p>
