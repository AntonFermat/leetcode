...
<h3>Hard</h3>
<div class="flex"></div><div class="xFUwe" data-track-load="description_content"><p>Given two arrays <code>nums1</code>&nbsp;and <code><span style="font-family: monospace; ">nums2</span></code><span style="font-family: monospace; ">.</span></p>
