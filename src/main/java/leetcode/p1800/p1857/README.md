...
<div><p>
<div class="_1l1MA" data-track-load="qd_description_content"><p>There is a <strong>directed graph</strong> of <code>n</code> colored nodes and <code>m</code> edges. The nodes are numbered from <code>0</code> to <code>n - 1</code>.</p>
